    ...
    function oa(a, b, c) {
      if (c && c.action) {
        ...
        if ("get" === d) {
          ...
          "post" === d &&
            ((a = X(a, b, c.action)), r.test(a) && (c.action = a));
      }
    }
    function ca(a) {
      try {
    ...
    var Fa,
      ...
      Pc = function (a, b, c) {
        ...
        e.open(
          "POST",
          (c ||
            "https://web.archive.org/web/20220611015033/https://ampcid.google.com/v1/publisher:getClientId") +
    ...
    var bd = function (a) {
        return (
          (a
            ...
            ? "https:"
            : "http:") +
          "//web.archive.org/web/20220611015033/https://www.google-analytics.com"
        );
      },
      Ge = function (a) {
        switch (a) {
      ...
      oc = function (a, b, c) {
        if (0 === b.length) c();
          ...
          switch (d) {
            case "d":
              pe(
                "https://web.archive.org/web/20220611015033/https://stats.g.doubleclick.net/j/collect",
                a.U,
                a,
                c
              );
            ...
            case "g":
              wc(
                "https://web.archive.org/web/20220611015033/https://www.google.com/ads/ga-audiences",
                a.google,
                c
              );
              (b = b.substring(1)) &&
                (/^[a-z.]{1,6}$/.test(b)
                  ? wc(
                      "https://web.archive.org/web/20220611015033/https://www.google.%/ads/ga-audiences".replace(
                        "%",
                        b
                      ),
                      a.google,
      ...
      try {
        if (!a.get(Qe) && (a.set(Qe, !0), !a.get("&gtm"))) {
          ...
          !b &&
            D(
              M.referrer,
              "https://web.archive.org/web/20220611015033/https://tagassistant.google.com/"
            ) &&
            (b = 3);
          !b && Ee(M.cookie.split("; "), "__TAG_ASSISTANT=x") && (b = 4);
          if (!b) {
            var c = M.documentElement.getAttribute(
          ...
          if (b) {
            O["google.tagmanager.debugui2.queue"] ||
              ((O["google.tagmanager.debugui2.queue"] = []),
              Id(
                "https://web.archive.org/web/20220611015033/https://www.google-analytics.com/debug/bootstrap?id=" +
                  a.get(Na) +
                  "&src=LEGACY&cond=" +
                  b
              ));
        ...
        a: {
          ...
          if (/^(https?|android-app):\/\//i.test(l)) {
            ...
            if (!de(l, g)) {
              if (
                ca &&
                ((ca = g.replace(/\./g, "-") + ".cdn.ampproject.org"),
                de(l, ca))
              ) {
                l = void 0;
                break a;
...
/*
     FILE ARCHIVED ON 01:50:33 Jun 11, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:14:08 May 06, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.115
  esindex: 0.01
  LoadShardBlock: 86.38 (6)
  PetaboxLoader3.datanode: 87.85 (8)
  load_resource: 78.15 (2)
  PetaboxLoader3.resolve: 58.83 (2)
*/
