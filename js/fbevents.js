            ...
            t = (function () {
              ...
              h(b, [
                ...
                },
                {
                  ...
                  value: function (a) {
                    u(
                      new Error("Calling legacy api getAutomaticMatchingConfig")
                    );
      ...
      f.ensureModuleRegistered("SignalsFBEventsJSLoader", function () {
        return (function (f, g, h, i) {
          ...
          (function () {
            ...
            var a = {
              CDN_BASE_URL:
                "https://web.archive.org/web/20220522052634/https://connect.facebook.net/",
            };
            function b() {
              ...
              switch (a.type) {
                ...
                case "NONSTANDARD_EVENT":
                  ...
                  return (
                    ...
                    e +
                    "'. The preferred way to send these events is using trackCustom. See 'https://web.archive.org/web/20220522052634/https://developers.facebook.com/docs/ads-for-websites/pixel-events/#events' for more information."
                  );
      ...
      f.ensureModuleRegistered("SignalsFBEventsNetworkConfig", function () {
        return (function (f, g, h, i) {
          ...
          (function () {
            ...
            var a = {
              ENDPOINT:
                "https://web.archive.org/web/20220522052634/https://www.facebook.com/tr/",
              INSTAGRAM_TRIGGER_ATTRIBUTION:
                "https://web.archive.org/web/20220522052634/https://www.instagram.com/tr/",
              AEM_ENDPOINT:
                "https://web.archive.org/web/20220522052634/https://www.facebook.com/.well-known/aggregated-event-measurement/",
            };
            j.exports = a;
          })();
          return j.exports;
          ...
          (function () {
            ...
            function A(a) {
              var b = a.customData,
                ...
                m = a.referrerLink,
                n = i.href;
              Object.prototype.hasOwnProperty.call(a, "documentLink") &&
                (n = l);
              l = h.referrer;
              Object.prototype.hasOwnProperty.call(a, "referrerLink") &&
                (l = m);
              a = new e(k);
              a.append("id", j);
              a.append("ev", f);
        ...
        return (function (g, h, i, j) {
          ...
          (function () {
            ...
            var e = Math.random(),
              ...
              i = e < d || h === "canary",
              j =
                "https://web.archive.org/web/20220522052634/https://connect.facebook.net/log/fbevents_telemetry/";
            function l(d) {
              var e =
                  arguments.length > 1 && arguments[1] !== void 0
                    ? arguments[1]
        ...
        return (function (a, b, c, d) {
          ...
          (function () {
              ...
              switch (a) {
                ...
                case "pcmInstagramTriggerAttribution":
                  ...
                  V.pluginConfig.set(C, "pcmInstagramTriggerAttribution", {
                    pcmInstagramTriggerAttributionURL:
                      k.INSTAGRAM_TRIGGER_ATTRIBUTION,
                  });
                  break;
            ...
            function ra(a, b, c, d) {
              ...
              e.append("coo", g);
              i = V.pluginConfig.getWithGlobalFallback(
                a ? a.id : null,
                "dataProcessingOptions"
              );
              if (i != null) {
            ...
            function va() {
              "onpageshow" in a &&
                a.addEventListener("pageshow", function (a) {
                  if (a.persisted) {
                    a = new ka({ allowDuplicatePageViews: !0 });
                    X.call(a, "trackCustom", "PageView");
                  }
                });
            }
...
/*
     FILE ARCHIVED ON 05:26:34 May 22, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:14:11 May 06, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.127
  esindex: 0.012
  LoadShardBlock: 59.92 (6)
  PetaboxLoader3.datanode: 98.296 (8)
  load_resource: 183.395 (2)
  PetaboxLoader3.resolve: 109.914 (2)
*/
